...
import {Text, View, StyleSheet, SafeAreaView, Platform, StatusBar, Image, TextInput, ScrollView} from 'react-native';
  ...
  render() {
   if(!this.state.fontsLoaded){
    ...
    return (
      ...
      <Text style={styles.appTitleText}>New Stories</Text>
      </View>
      </View> 
      ...
      <DropDownPicker 
        ...
        textStyle={{
          color:this.state.dropdownHeight==170?"blue":"white",
